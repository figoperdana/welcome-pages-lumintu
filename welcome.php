...
<body>
  <div class="bg-white w-full h-screen">
    ...
    ?>
    <header>
      <aside class="p-12 bg-gradient-to-br from-[#C27D2B] to-[#CEB27C] sm:p-16 lg:p-24">
        <div class="max-w-xl mx-auto text-center">
          <p class="mt-2 text-3xl text-white font-bold sm:text-5xl">
            Lumintu Learning
          </p>
          <br>
    ...
    <div class="container mx-auto px-4 pt-10 pb-6 ">
      ...
      <div class="flex flex-col items-center justify-center space-y-6 text-center">
      <img class="mt-10 rounded-2xl items-center" src="assets/img/cuate.png"/>
      <p class="text-xl tracking-normal">Kamu masih belum memilih kelas</p>
      </div>
    </div>
