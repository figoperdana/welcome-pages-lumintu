...
<body>
  <div class="bg-white w-full h-screen">
      ...
      <div class="max-w-screen-2xl px-4 py-8 mx-auto sm:py-6 sm:px-2 lg:px-2">
        <div class="sm:justify-between sm:items-center sm:flex">
          ...
          <div class="flex flex-col gap-4 mt-4 sm:flex-row sm:mt-0 sm:items-center">
            <button class="inline-flex items-center justify-center px-5 py-3 text-gray-500 transition border border-gray-200 rounded-lg hover:text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring" type="button">
              Lanjutkan Kelas
            </button>
          </div>
        </div>
    ...
    <!-- jumbotron -->
    <aside class="relative overflow-hidden text-white bg-gradient-to-br from-[#C27D2B] to-[#CEB27C] lg:flex" data-carousel-item="">
      <div class="relative w-full h-64 sm:h-96 lg:w-1/2 lg:h-auto">
        <img src="https://www.hyperui.dev/photos/women-2.jpeg" alt="Women smiling at college" class="absolute inset-0 object-cover w-full h-full" />
      </div>
      <div class="w-full p-12 text-center lg:w-1/2 sm:p-16 lg:p-24 lg:text-left">
        <div class="max-w-xl mx-auto lg:ml-0">
          ...
          <a href="" class="inline-block px-5 py-3 mt-8 text-sm font-medium text-white shadow bg-[#C27D2B] rounded-lg hover:bg-[#C19F7A]">
        ...
        <div class="flex flex-wrap">
          <div class="p-4 md:w-1/4" id="bantu1">
            <div class="h-full rounded-xl bg-white overflow-hidden shadow-lg">
              <a href="">
                <img class="lg:h-48 md:h-36 w-full object-top scale-100 transition-all duration-400 hover:scale-90" src="assets/img/Add tasks-pana.svg" alt="blog">
              </a>
              <a href="">
                <div class="p-6">
                  <br>
                  ...
                  <div class="text-center">
                    <a type="button" data-modal-toggle="defaultModal" class="cursor-pointer text-white bg-gradient-to-br from-[#C27D2B] to-[#CE7F21] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 shadow">Ayo Gabung Sekarang</a>
              </a>
            </div>
          </div>
